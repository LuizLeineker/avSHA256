# O CODIGO RECEBE O CONTEUDO E O HASH ANTERIOR DESSE CONTEUDO, O CONTEUDO PASSA PELO SHA256
# APÓS A FUNÇÃO DO SHA256 É FEITO UMA COMPARAÇÃO COM O HASH INSERIDO, SE NÃO FOR IGUAL SINAL QUE TEVE MUDANÇA NOS DADOS
...
hash = input("Informe o HASH: ")
print(f"Retorno do SHA256: {sha256(string)}")
if sha256(string) == hash:
    print("Os dados são autênticos! ")
else:
